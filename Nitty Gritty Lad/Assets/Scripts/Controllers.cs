...
internal sealed class Controllers : IInit, IExecute, ILateExecute, ICleanUp
{
    ...
    internal Controllers Add(IController controller)    //IController interface is needed to use all types of child interfaces as an argument
        //Categorizes the controller into Init, Exec, LateExec, Destroy categories and adds them to revelant list<>
    {
